...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [DHORF] = LAYOUT_ansi_61(
        KC_ESC,               KC_1,     KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,
        KC_TAB,               KC_V,     KC_L,    KC_H,    KC_K,    KC_Q,    KC_J,    KC_F,    KC_O,    KC_U,    KC_COMM,  KC_LBRC,  KC_RBRC,  KC_BSLS,
        MT(MOD_LCTL, KC_ESC), KC_S,     KC_R,    KC_N,    KC_T,    KC_W,    KC_Y,    KC_C,    KC_A,    KC_E,    KC_I,     KC_SLSH,  KC_ENT,
        KC_LSFT,              KC_Z,     KC_X,    KC_M,    KC_D,    KC_B,    KC_P,    KC_G,    KC_QUOT, KC_SCLN, KC_DOT,             KC_RSFT,
        KC_LCTL,              KC_LOPT,  KC_LCMD,                            KC_SPC,                             KC_RCMD,  MO(_FN1), MO(_FN3), KC_RCTL),
    ...
    [_FN3] = LAYOUT_ansi_61(
        KC_TILD, DF(QWERTY), DF(DHORF), KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12,   _______,
