...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [QGMLWB] = LAYOUT_ansi_61(
        KC_ESC,               KC_1,     KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,
        KC_TAB,               KC_Q,     KC_G,    KC_M,    KC_L,    KC_W,    KC_B,    KC_Y,    KC_U,    KC_V,    KC_SCLN,  KC_LBRC,  KC_RBRC,  KC_BSLS,
        MT(MOD_LCTL, KC_ESC), KC_D,     KC_S,    KC_T,    KC_N,    KC_R,    KC_I,    KC_A,    KC_E,    KC_O,    KC_H,     KC_QUOT,            KC_ENT,
        KC_LSFT,              KC_Z,     KC_X,    KC_C,    KC_F,    KC_J,    KC_K,    KC_P,    KC_COMM, KC_DOT,  KC_SLSH,            KC_RSFT,
        KC_LCTL,              KC_LOPT,  KC_LCMD,                            KC_SPC,                             KC_RCMD,  MO(_FN1), MO(_FN3), KC_RCTL),
    ...
    [_FN3] = LAYOUT_ansi_61(
        KC_TILD, DF(QWERTY), DF(QGMLWB),   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12,   _______,
